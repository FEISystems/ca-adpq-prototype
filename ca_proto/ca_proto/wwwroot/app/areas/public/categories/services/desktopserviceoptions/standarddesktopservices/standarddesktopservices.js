(function () {
    ...
    var controller = function ($scope, $location, messageService, inventoryService) {
        var model = this;
        model.provider = {};
        model.title = "Standard Desktop Services";
       ...
       model.pageCount = 500;
        ...
        this.$routerOnActivate = function (next, previous) {
            ...
            messageService.subscribe('querySuccess', function (response) {
                ...
                var filteredList = response.filter(function(items) { return items.Category === "Service Options Upgrades Standard/ Power Desktop" || 
    ...
    module.component("standardDesktopServices", {
        templateUrl: "app/areas/public/categories/services/desktopserviceoptions/standarddesktopservices/standarddesktopservices.html",
        controllerAs: "model",
