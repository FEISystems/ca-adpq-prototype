(function () {
    ...
    var controller = function ($scope, $location, messageService, inventoryService) {
        var model = this;
        model.provider = {};
        model.title = "Ultralight Laptop Services";
    ...
    module.component("ultralightLaptopServices", {
        templateUrl: "app/areas/public/categories/services/laptopserviceoptions/ultralightlaptopservices/ultralightlaptopservices.html",
        controllerAs: "model",
