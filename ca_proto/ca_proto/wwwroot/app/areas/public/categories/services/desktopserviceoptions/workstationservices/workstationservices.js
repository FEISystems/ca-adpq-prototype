(function () {
    ...
    var controller = function ($scope, $location, messageService, inventoryService) {
        var model = this;
        model.provider = {};
        model.title = "Workstation Services";
        ...
        this.$routerOnActivate = function (next, previous) {
            ...
            messageService.subscribe('querySuccess', function (response) {
                ...
                var filteredList = response.filter(function(items) { return items.Category === "Service Options Upgrades Workstation Desktop"
                });
    ...
    module.component("workstationServices", {
        templateUrl: "app/areas/public/categories/services/desktopserviceoptions/workstationservices/workstationservices.html",
        controllerAs: "model",
