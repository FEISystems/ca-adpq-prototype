(function () {
    ...
    var controller = function ($scope, $location, messageService, inventoryService) {
        var model = this;
        model.provider = {};
        model.title = "All Laptop Services";
        ...
        this.$routerOnActivate = function (next, previous) {
            ...
            messageService.subscribe('querySuccess', function (response) {
                ...
                var filteredList = response.filter(function(items) { return items.Category === "Service Options/Upgrades All Laptops"  ||  
                    ...
                    items.Category === "Service Options/Upgrades Power Laptop" || 
                    items.Category === "Service Options/Upgrades Standard Laptop" ||  
                    items.Category === "Service Options/Upgrades Standard, Power,Ultralight" ||  
                    items.Category === "Service Options/Upgrades Ultralight Laptop"
                });
    ...
    module.component("allLaptopServices", {
        templateUrl: "app/areas/public/categories/services/laptopserviceoptions/alllaptopservices/alllaptopservices.html",
        controllerAs: "model",
