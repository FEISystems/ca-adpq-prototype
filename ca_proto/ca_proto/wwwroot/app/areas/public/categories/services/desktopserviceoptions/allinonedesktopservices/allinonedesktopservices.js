(function () {
    ...
    var controller = function ($scope, $location, messageService, inventoryService) {
        var model = this;
        model.provider = {};
        model.title = "All in One Desktop Services";
    ...
    module.component("allInOneDesktopServices", {
        templateUrl: "app/areas/public/categories/services/desktopserviceoptions/allinonedesktopservices/allinonedesktopservices.html",
        controllerAs: "model",
