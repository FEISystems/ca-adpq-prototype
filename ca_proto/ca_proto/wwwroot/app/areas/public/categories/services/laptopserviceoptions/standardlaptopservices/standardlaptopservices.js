(function () {
    ...
    var controller = function ($scope, $location, messageService, inventoryService) {
        var model = this;
        model.provider = {};
        model.title = "Standard Laptop Services";
    ...
    module.component("standardLaptopServices", {
        templateUrl: "app/areas/public/categories/services/laptopserviceoptions/standardlaptopservices/standardlaptopservices.html",
        controllerAs: "model",
