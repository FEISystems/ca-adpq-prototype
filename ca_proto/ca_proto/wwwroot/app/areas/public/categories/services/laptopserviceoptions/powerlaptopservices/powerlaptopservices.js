(function () {
    ...
    var controller = function ($scope, $location, messageService, inventoryService) {
        var model = this;
        model.provider = {};
        model.title = "Power Laptop Services";
    ...
    module.component("powerLaptopServices", {
        templateUrl: "app/areas/public/categories/services/laptopserviceoptions/powerlaptopservices/powerlaptopservices.html",
        controllerAs: "model",
