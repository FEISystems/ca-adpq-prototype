(function () {
    ...
    var controller = function ($scope, $location, messageService, inventoryService) {
        var model = this;
        model.provider = {};
        model.title = "Power Desktop Services";
    ...
    module.component("powerDesktopServices", {
        templateUrl: "app/areas/public/categories/services/desktopserviceoptions/powerdesktopservices/powerdesktopservices.html",
        controllerAs: "model",
